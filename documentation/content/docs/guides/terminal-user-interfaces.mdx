...
## Use the Fission CLI as the reference example

The interactive Fission CLI is a terminal Fission app. Running `fission ui --project-dir .` opens an app built from normal Fission widgets and hosted by `TerminalApp`.
