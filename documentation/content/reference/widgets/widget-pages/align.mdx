...
| --- | --- | --- | --- |
| `id` | `Option<WidgetId>` | Stable widget identity. | Defaults to `None`, so the runtime generates an id. |
| `child` | `Widget` | The widget to center. | Required. `Align` is a single-child layout wrapper. |
