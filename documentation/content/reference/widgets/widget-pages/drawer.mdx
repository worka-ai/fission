...
| --- | --- | --- | --- |
| `id` | `WidgetId` | Stable identity for the portal entry. | Required. Give each drawer a stable id so the runtime can track it consistently. |
...
| `content` | `Widget` | The panel body. | Build the full drawer user interface here. |
