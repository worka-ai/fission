...
Capacity headroom gauge belongs to the **Radial** family. Its job is to make this data shape readable: `Single capacity value in a bounded range.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
