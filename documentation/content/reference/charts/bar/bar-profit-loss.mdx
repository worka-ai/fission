...
Profit and loss bars belongs to the **Bar** family. Its job is to make this data shape readable: `Positive and negative values on one value axis.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
