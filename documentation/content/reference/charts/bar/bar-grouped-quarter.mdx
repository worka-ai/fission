...
Grouped quarterly bars belongs to the **Bar** family. Its job is to make this data shape readable: `Multiple BarSeries on the same categories.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
