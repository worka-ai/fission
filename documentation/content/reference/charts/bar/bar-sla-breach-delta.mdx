...
SLA breach delta belongs to the **Bar** family. Its job is to make this data shape readable: `Deltas above and below a service baseline.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
