...
3D risk terrain belongs to the **3D and GL** family. Its job is to make this data shape readable: `Terrain surface using native mesh rendering.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
