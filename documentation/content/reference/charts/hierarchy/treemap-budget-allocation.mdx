...
Budget allocation treemap belongs to the **Hierarchy** family. Its job is to make this data shape readable: `Nested budget values sized by area.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
