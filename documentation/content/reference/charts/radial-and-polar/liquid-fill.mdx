...
Liquid fill belongs to the **Radial and polar** family. Its job is to make this data shape readable: `One or more percentages.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
