...
Radar profile A belongs to the **Pie and radial** family. Its job is to make this data shape readable: `Vec<Vec<f32>> metric profiles.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
