...
Export toolbox belongs to the **Interaction** family. Its job is to make this data shape readable: `Chart data with restore, brush, zoom, and save actions.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
