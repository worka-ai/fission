...
Brush outliers belongs to the **Interaction** family. Its job is to make this data shape readable: `Point data with visible brush preview.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
