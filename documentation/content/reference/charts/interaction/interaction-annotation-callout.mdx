...
Annotation callout belongs to the **Interaction** family. Its job is to make this data shape readable: `Chart data with a typed text callout.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
