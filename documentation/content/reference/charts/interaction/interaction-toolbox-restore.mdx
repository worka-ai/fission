...
Restore toolbox belongs to the **Interaction** family. Its job is to make this data shape readable: `Chart data with reset action included.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
