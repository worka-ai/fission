...
Sales map belongs to the **Geo and route** family. Its job is to make this data shape readable: `GeoJSON regions plus values.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
