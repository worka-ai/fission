...
Large matrix heatmap belongs to the **Heatmap and calendar** family. Its job is to make this data shape readable: `Dense matrix value triples.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
