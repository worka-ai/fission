...
Stacked revenue dataset belongs to the **Dataset** family. Its job is to make this data shape readable: `Multiple encoded measures over one category axis.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
