...
Live status gauge belongs to the **Dataset** family. Its job is to make this data shape readable: `Single changing status value.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
