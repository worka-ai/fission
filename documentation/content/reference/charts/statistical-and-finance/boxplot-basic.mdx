...
Boxplot belongs to the **Statistical and finance** family. Its job is to make this data shape readable: `Rows of five-number summaries or raw groups.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
