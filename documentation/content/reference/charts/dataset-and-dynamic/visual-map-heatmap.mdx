...
Visual map heatmap belongs to the **Dataset and dynamic** family. Its job is to make this data shape readable: `Grid cell coordinates with numeric intensity.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
