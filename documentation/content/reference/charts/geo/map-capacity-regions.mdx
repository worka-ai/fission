...
Capacity regions map belongs to the **Geo** family. Its job is to make this data shape readable: `Region values with visual scale.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
