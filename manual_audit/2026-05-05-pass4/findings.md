...
- `counter`
  ...
  - Screenshot: `manual_audit/2026-05-05-pass4/counter/02_modal.png`
- `text-lab`
  - Closing the modal via Apply no longer leaves stale combobox suggestion text painted on the base page.
  - Screenshot: `manual_audit/2026-05-05-pass4/text-lab/04_after_apply.png`
- `inbox`
  - Settings modal now opens with readable row heights and no compositor scissor crash.
  - Screenshot: `manual_audit/2026-05-05-pass4/inbox/06_settings_fixed.png`
- `editor`
  - Tapping a visible file from the explorer opens it without crashing.
  - Ctrl+F now opens the find / replace bar.
  - Screenshots: `manual_audit/2026-05-05-pass4/editor/02_readme.png`, `manual_audit/2026-05-05-pass4/editor/05_find_bar.png`
- `chart-gallery`
...
- `inbox` — compose schedule controls are still visually poor.
  ...
  - Screenshot: `manual_audit/2026-05-05-pass4/inbox/02_compose.png`
...
- `animation-gallery` — wide resize is functionally correct but not responsive enough.
  ...
  - Screenshot: `manual_audit/2026-05-05-pass4/animation-gallery/03_wide_resize.png`
