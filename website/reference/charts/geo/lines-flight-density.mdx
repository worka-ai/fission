...
Flight density lines belongs to the **Geo** family. Its job is to make this data shape readable: `Dense route lines between points.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
