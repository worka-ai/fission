...
Hourly load polar bars belongs to the **Radial** family. Its job is to make this data shape readable: `Label/value pairs around a circle.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
