...
Market share pie belongs to the **Analytics** family. Its job is to make this data shape readable: `Label/value market share pairs.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
