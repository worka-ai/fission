...
Negative delta bars belongs to the **Bar** family. Its job is to make this data shape readable: `BarSeries values crossing zero.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
