...
Crypto session candlestick belongs to the **Statistical** family. Its job is to make this data shape readable: `OHLC values over intraday buckets.` In a production interface, choose this chart when the visual form makes the user's question faster to answer than a table or a simpler chart would.
